...
- `references/api-guide/12-video-basic-processing.md`：视频基础剪辑、截取、分辨率、智能优化、滤镜、镜像、缩放和画面移动。
...
- 视频基础处理：`12-video-basic-processing.md`。
...
- 用户要做视频基础剪辑、截取、分辨率、智能优化、滤镜、镜像、缩放或画面移动：读 `12-video-basic-processing.md`。
